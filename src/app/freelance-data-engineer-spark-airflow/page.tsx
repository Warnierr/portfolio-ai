        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-xs bg-emerald-500/20 text-emerald-300 px-3 py-1 rounded-full">Scala</span>
              <span className="text-xs bg-emerald-500/20 text-emerald-300 px-3 py-1 rounded-full">Spark SQL</span>
              <span className="text-xs bg-emerald-500/20 text-emerald-300 px-3 py-1 rounded-full">Jenkins</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-xs bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full">Ansible</span>
              <span className="text-xs bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full">Airflow</span>
              <span className="text-xs bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full">Spark</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-xs bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full">Spark</span>
              <span className="text-xs bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full">Hadoop</span>
              <span className="text-xs bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full">Airflow</span>
            </div>
          </div>
        </div>
      </section>
