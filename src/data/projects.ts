...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    title: "Data Engineer Big Data — BNP Paribas",
    type: "mission",
    tldr: "Développement et maintenance de pipelines Scala/Spark pour un Datalake bancaire critique. Ingestion de données, gestion HDFS, et validation des flux via Spark Shell/SQL et Jenkins.",
    context: {
      client: "BNP Paribas",
    ...
    problem: {
      situation: "Environnement Big Data existant nécessitant des évolutions continues et une maintenance rigoureuse des flux d'ingestion.",
      stakes: "Garantir la disponibilité des données pour les équipes aval et assurer la conformité des traitements bancaires.",
    },
    constraints: [
      "Environnement de production strict (Banque)",
      "Validation manuelle et automatisée des données (HDFS/Shell)",
      "Processus de déploiement rigoureux via Jenkins",
    ],
    decisions: [
      {
        choice: "Scala & Spark",
        why: "Standard du Datalake pour le traitement performant et robuste des volumes massifs.",
      },
      {
        choice: "Vérification Shell & HDFS",
        why: "Contrôle qualité indispensable pour valider la réception et l'intégrité des fichiers avant ingestion.",
      },
    ],
    delivered: [
      "Code Scala fonctionnel pour l'évolution des pipelines",
      "Documentation technique pour le SharePoint d'équipe",
      "Processus d'ingestion validés en environnement de dév (livrés aux ops pour pré-prod/prod)",
    ],
    results: {
      metrics: [
        "Ingestion fiable des datasets critiques",
        "Réduction des erreurs de traitement grâce aux validations Spark SQL",
      ],
      qualitative: "Une contribution technique précise assurant la stabilité du Datalake et la qualité des données livrées.",
    },
    retrospective: [
      "La rigueur des tests en Spark Shell connecté à l'environnement est cruciale pour éviter les régressions.",
    ],
    stack: ["Scala", "Spark", "Spark SQL", "HDFS", "Jenkins", "Shell", "Linux", "SQL"],
  },
  {
